...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference("Seller.count") do
      post sellers_url, params: { seller: { charge: @seller.charge, email: @seller.email, name: @seller.name } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { charge: @seller.charge, email: @seller.email, name: @seller.name } }
